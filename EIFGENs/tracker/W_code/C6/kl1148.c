...
extern EIF_TYPED_VALUE F1148_10047(EIF_REFERENCE);
...
RTOID (F1148_10047)
EIF_TYPED_VALUE F1148_10047 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1147, Current, 0, 0, 16694);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1147, Current, 16694);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
