...
extern EIF_TYPED_VALUE F1128_9960(EIF_REFERENCE);
...
#define Result RTOTRB(EIF_INTEGER_32)
	...
	RTEAA(l_feature_name, 1127, Current, 0, 0, 16334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1127, Current, 16334);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
#define Result RTOTRB(EIF_INTEGER_32)
	...
	RTEAA(l_feature_name, 1127, Current, 0, 0, 16335);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1127, Current, 16335);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
#define Result RTOTRB(EIF_INTEGER_32)
	...
	RTEAA(l_feature_name, 1127, Current, 0, 0, 16336);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1127, Current, 16336);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
#define Result RTOTRB(EIF_INTEGER_32)
	...
	RTEAA(l_feature_name, 1127, Current, 0, 0, 16337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1127, Current, 16337);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
#define Result RTOTRB(EIF_INTEGER_32)
	...
	RTEAA(l_feature_name, 1127, Current, 0, 0, 16338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1127, Current, 16338);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1128_9954);
	dtype = Dtype(Current);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1128_9955);
	dtype = Dtype(Current);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1128_9956);
	dtype = Dtype(Current);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1128_9957);
	dtype = Dtype(Current);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1128_9958);
	dtype = Dtype(Current);
...
#define Result RTOTRB(EIF_INTEGER_64)
	RTOTDB(EIF_INTEGER_64, F1128_9959);
...
RTOID (F1128_9960)
EIF_TYPED_VALUE F1128_9960 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_64)
	RTOTDB(EIF_INTEGER_64, F1128_9960);
...
void EIF_Minit1128 (void)
{
	...
	RTOTS (9956,F1128_9956)
	RTOTS (9957,F1128_9957)
	RTOTS (9958,F1128_9958)
	RTOTS (9959,F1128_9959)
	RTOTS (9960,F1128_9960)
}
