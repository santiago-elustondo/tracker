...
extern void F1124_9891(EIF_REFERENCE);
extern void F1124_9892(EIF_REFERENCE);
extern void F1124_16276(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1124_9890 (EIF_REFERENCE Current)
{
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7579, Dtype(Current)))(Current)).it_i4);
...
/* {ROOT}.add_tests */
void F1124_9891 (EIF_REFERENCE Current)
{
	GTCX
...
/* {ROOT}._invariant */
void F1124_16276 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1123, Current, 0, 16275);
	RTSA(dtype);
	RTME(dtype, 0);
