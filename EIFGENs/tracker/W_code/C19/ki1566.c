...
extern EIF_TYPED_VALUE F1566_9029(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1566_9030(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1566_9032(EIF_REFERENCE);
extern void F1566_9037(EIF_REFERENCE);
extern void F1566_9038(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1566_9029 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1565, Current, 2, 3, 15281);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1565, Current, 15281);
	{
...
EIF_TYPED_VALUE F1566_9030 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1565, Current, 0, 0, 15282);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1565, Current, 15282);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1566_9032 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1565, Current, 0, 0, 15283);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1565, Current, 15283);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F1566_9037 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1565, Current, 0, 0, 15284);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1565, Current, 15284);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1566_9038 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1565, Current, 0, 0, 15285);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1565, Current, 15285);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
