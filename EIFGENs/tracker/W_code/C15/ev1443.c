...
static EIF_TYPED_VALUE F1443_13836_body(EIF_REFERENCE);
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1442, Current, 0, 0, 20216);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1442, Current, 20216);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1443_13836_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1442, Current, 0, 0, 20217);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1442, Current, 20217);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1443_13836 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9236, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1443_13836_body (Current)).it_r;
