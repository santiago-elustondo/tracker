...
extern void F1424_13502(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1424_13503(EIF_REFERENCE);
static EIF_TYPED_VALUE F1424_13504_body(EIF_REFERENCE);
...
void F1424_13502 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1423, Current, 0, 1, 19960);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1423, Current, 19960);
	RTCC(arg1, 1423, l_feature_name, 1, RTWCT(9236, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1424_13503 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1423, Current, 0, 0, 19961);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9231, 1421))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1424_13504_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1423, Current, 0, 0, 19962);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1424_13504 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9236, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1424_13504_body (Current)).it_r;
