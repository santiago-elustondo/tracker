...
extern void F1423_13499(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1423_13500(EIF_REFERENCE);
...
void F1423_13499 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 1422, l_feature_name, 1, RTWCT(9236, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1423_13500 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1423_13501_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1422, Current, 0, 0, 19959);
	RTSA(Dtype(Current));
	RTSC;
