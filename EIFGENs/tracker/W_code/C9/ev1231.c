...
extern EIF_TYPED_VALUE F1231_10724(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1231_10724 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1230, Current, 0, 0, 17477);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1230, Current, 17477);
	RTIV(Current, RTAL);
	RTHOOK(1);
