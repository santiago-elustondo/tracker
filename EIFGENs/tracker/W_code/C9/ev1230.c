...
extern EIF_TYPED_VALUE F1230_10722(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1230_10722 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1229, Current, 0, 0, 17476);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1229, Current, 17476);
	RTIV(Current, RTAL);
	RTHOOK(1);
