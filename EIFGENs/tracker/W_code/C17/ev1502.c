...
extern void F1502_14774(EIF_REFERENCE);
extern void F1502_14775(EIF_REFERENCE);
...
void F1502_14774 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 10883, 0x04000000, 1); /* focus_on_press_disabled */
...
void F1502_14775 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1502_14777_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1501, Current, 0, 0, 20991);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1501, Current, 20991);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
