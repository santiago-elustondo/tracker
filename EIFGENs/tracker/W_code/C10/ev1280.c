...
extern EIF_TYPED_VALUE F1280_11452(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1280_11452 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1279, Current, 0, 0, 18211);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1279, Current, 18211);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8301, 0xF800058C, 0); /* implementation */
