...
extern void F1181_10235(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1181_10235 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1180, Current, 0, 2, 16870);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1180, Current, 16870);
	RTCC(earg1, 1180, l_feature_name, 1, eif_new_type(1181, 0x00), 0x00);
	RTCC(earg2, 1180, l_feature_name, 2, eif_new_type(1181, 0x00), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
