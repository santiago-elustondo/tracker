...
extern EIF_TYPED_VALUE F1184_10286(EIF_REFERENCE);
...
RTOID (F1184_10286)
EIF_TYPED_VALUE F1184_10286 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1183, Current, 0, 0, 16973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1183, Current, 16973);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
