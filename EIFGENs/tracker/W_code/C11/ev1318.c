...
extern EIF_TYPED_VALUE F1318_11890(EIF_REFERENCE);
extern void F1318_11891(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1318_11890 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1318_11891 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1317, Current, 0, 0, 18650);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1317, Current, 18650);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8301, 0xF80005CF, 0); /* implementation */
