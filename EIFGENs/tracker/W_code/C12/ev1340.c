...
static EIF_TYPED_VALUE F1340_12111_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1340_12111_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1339, Current, 0, 0, 18865);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1340_12111 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9236, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1340_12111_body (Current)).it_r;
