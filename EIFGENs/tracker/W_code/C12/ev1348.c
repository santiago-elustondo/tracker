...
static EIF_TYPED_VALUE F1348_12288_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1348_12288_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1347, Current, 0, 0, 18983);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1347, Current, 18983);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1348_12288 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9236, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1348_12288_body (Current)).it_r;
